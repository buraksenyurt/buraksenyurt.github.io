...
Eğer bu sonuçları elde edebiliyorsak servisimizin çalıştığını ve Silverlight tarafı için kullanılabilir olduğunu söyleyebiliriz. Lakin dikkat etmemiz gereken bir nokta daha vardır.
