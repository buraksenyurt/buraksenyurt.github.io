...
builder.Services
    .AddMcpServer()
    .WithStdioServerTransport() // UPDATE bölümünde SSE destekli iletişim örneği de var
...
![MCPServer_08.png](/assets/images/2026/MCPServer_08.png)

Ekran görüntüsünden de görüldüğü üzere yeni MCP sunucusundan sunulan araçlar başarılı şekilde keşfedilmiştir.

![MCPServer_09.png](/assets/images/2026/MCPServer_09.png)

![MCPServer_10.png](/assets/images/2026/MCPServer_10.png)
