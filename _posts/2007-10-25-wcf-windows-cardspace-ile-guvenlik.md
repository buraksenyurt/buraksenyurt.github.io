...
İstemci uygulamaya geçmeden önce servis uygulaması herhangibir tarayıcı penceresinden talep edilirse KeySet Does Not Exist mesajlı bir çalışma zamanı istisnası alınabilir. Böyle bir durumda WinHttpCertCfg.exe aracı kullanılarak NetworkService yada AspNet hesaplarına (accounts), uygulamada kullanılan sertifika (Certificate) için kabul edilmiş erişim (grant access) haklarının verilmesi gerekmektedir. [WinHttpCertCfg aracı bu adresten tedarik edilebilir](http://www.microsoft.com/downloads/details.aspx?familyid=c42e27ac-3409-40e9-8667-c748e422833f). Bu araç aşağıdaki ekran görüntüsünde olduğu gibi kullanılmalıdır.
