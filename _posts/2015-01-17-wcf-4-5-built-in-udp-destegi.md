...
> Hatırlayalım! Metadata paylaşımı için kullanılan sözleşme tipi.Net Framework içerisinde Built-In olarak gelen IMetadataExchange arayüzünde (Interface) tanımlanmıştır.
