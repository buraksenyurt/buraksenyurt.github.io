...
![OllamaWithNet_00.png](/assets/images/2025/OllamaWithNet_00.png)
...
![OllamaWithNet_01.png](/assets/images/2025/OllamaWithNet_01.png)
...
![OllamaWithNet_07.png](/assets/images/2025/OllamaWithNet_07.png)

Artık local makinede çalışan bir dil modelimiz mevcut. Hatta bunu list parametresi ile terminalden de görebilmemiz lazım.

![OllamaWithNet_02.png](/assets/images/2025/OllamaWithNet_02.png)
...
![OllamaWithNet_03.png](/assets/images/2025/OllamaWithNet_03.png)
...
![OllamaWithNet_04.png](/assets/images/2025/OllamaWithNet_04.png)
...
![OllamaWithNet_05.png](/assets/images/2025/OllamaWithNet_05.png)
...
Processor
12th Gen Intel (R) Core (TM) i7-1255U, 1700 Mhz, 10 Core (s), 12 Logical Processor (s)
...
![OllamaWithNet_06.png](/assets/images/2025/OllamaWithNet_06.png)
...
Yazının bundan sonraki kısmında farklı modellerden çeşitli prompt'lar üretip söz konusu dosyanın yorumlanmasını isteyebiliriz. Lakin endüstriyel anlamda baktığımda milyon satır kod tabanına ulaşabilen sistemlerin kod kalitesinin ölçümü için çok daha fazla parametre ile çalışan (ki tahminlere göre Chat Gpt-4o versiyonu neredeyse 2 trilyon parametre ile çalışıyor) ve pek tabii çok daha yüksek sistem konfigürasyonuna ihtiyaç duyan ve pek tabiii daha çok enerji ihtiyacı duyacak ortamlara ihtiyacımız olacağı kesin. Tüm bu gelişmelere karşın Microsoft'un yapay zeka modellerini kod tabanında kolayca kullanabilmemiz için soyutlamalar getirmesi, Ollama'nın OpenAI'ın tüm karşıt görüşleri ve tutumlarına rağmen DeepSeek'i model kataloğunda tutması (en azından şimdilik) çok farklı bir geleceğin göstergesi gibi.
...
![OllamaWithNet_08.png](/assets/images/2025/OllamaWithNet_08.png)
