...
> Hatırlayacağınız gibi web tarafındaki ilk veri bağlı kontrollerde sayfalama sistemi şöyle çalışmaktaydı: Sorgulama sırasında tüm veri çekilir ve içinden örneğin Xnci sıradaki 10 luk eleman kümesi getirilirdi. Çok doğal olarak her seferinde tüm veri kümesinin çekilmesi çok da istenen bir yaklaşım değildi. Örneğin 10 milyon satır içinden 3ncü 50lik kümeyi getirmek istediğimizde. Ancak ilerleyen sürümler de bu durum değişti ve özellikle SQL tarafında row_number kullanımı ile doğru sayfalama işlemlerinin yapılabilmesinin yolu açıldı. Buna bir de LINQ tarafındaki anahtar kelime desteği eklenince, Entity Framework gibi alanlarda doğru sayfalama stratejilerini kullanabilir olduk.
...
![wapip_1](/assets/images/2013/wapip_1.png)
...
![wapip_3](/assets/images/2013/wapip_3.png)

knockout.js

![wapip_4](/assets/images/2013/wapip_4.png)

ve Microsoft ASP.NET Web API OData

![wapip_5](/assets/images/2013/wapip_5.png)

Bu eklentilerin yüklenmesi sonrasında jQuery ve knockout.js için scripts klasörü aşağıdaki hale gelecektir.

![wapip_6](/assets/images/2013/wapip_6.png)
...
![wapip_2](/assets/images/2013/wapip_2.png)
...
![wapip_7](/assets/images/2013/wapip_7.png)
...
![wapip_8](/assets/images/2013/wapip_8.png)
...
![wapip_10](/assets/images/2013/wapip_10.png)
...
![wapip_11](/assets/images/2013/wapip_11.png)

Şimdi bazı veriler girerek örneğimizi test edelim.

![wapip_12](/assets/images/2013/wapip_12.png)
...
![wapip_13](/assets/images/2013/wapip_13.png)
