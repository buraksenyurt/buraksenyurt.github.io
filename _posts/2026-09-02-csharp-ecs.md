...
- Query sınıfını geliştirmek gerekiyor. Birden fazla **IComponent** türevini ele alabilmeli *(Güncel geliştirmeler için [BevyDotNet örnek kodlarına](https://github.com/buraksenyurt/friday-night-programmer/tree/main/src/BevyDotNet) bakabilirsiniz. Source Code Generator müdahalesi ile Query sınıf hiç olmazsa 8 bileşene kadar destek verebiliyor.)*
