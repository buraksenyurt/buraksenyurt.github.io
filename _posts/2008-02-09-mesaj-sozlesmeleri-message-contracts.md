...
[ServiceContract (Name="ProductTransferService",Namespace="http://Northwind/ProductTransferService")]
...
int
result=client.CompleteOrderProcess (DateTime.Now,
...
2009-02-08T01:53:03+02:00

9476df3d-0f74-4643-9fcf-b7344d5da37d
...
R0lGODlhIAAgAPcAAAAAAB8hNR4hODMpHCQgLiIkNyYqRysvUC4wQy
...
2009-02-08T01:53:03.46875+02:00
...
GetBody metodundan yararlanılır. Tahmin edileceği üzere
...
Product[] response = reply.GetBody ();
...
mesaja ait Body bilgisinin okunması içinde GetBody metodundan
...
[MSDN](http://msdn.microsoft.com/en-us/library/ms730255(printer).aspx)' de yayınlanan içeriği takip etmenizi öneririm. Böylece geldik bir
makalemizin daha sonuna. Bir sonraki makalemizde görüşünceye dek
hepinize mutlu günler dilerim

[Örneği
İndirmek İçin Tıklayın](/assets/files/2008/UsingMessageContracts.rar)
