...
const (
    PlayerType_SEMI PlayerType = 0 PlayerType_PRO PlayerType = 1 PlayerType_MASTER PlayerType = 2
)
...
func(m * Player_Weapon) String() string {
    return proto.CompactTextString(m)
}
func( * Player_Weapon) ProtoMessage() {}
func( * Player_Weapon) Descriptor()([] byte, [] int) {
    return fileDescriptor0, [] int {
        0, 0
    }
}
...
func init() {
    proto.RegisterFile("Southwind.proto", fileDescriptor0)
}
