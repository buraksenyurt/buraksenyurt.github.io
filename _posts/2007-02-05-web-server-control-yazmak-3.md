...
Bazı durumlarda PostBack verilerini ele almak istemiyor olabiliriz. Yani amaç sadece istemciden sunucuya doğru olay tetikletmek olabilir. Bu gibi durumlarda ilgili olayları tetikleyebilmek için IPostBackEventHandler arayüzünden faydalanabiliriz. Bu arayüz, uygulandığı kontrol içerisinde RaisePostBackEvent metodunun yazılmasını zorlayacaktır. Bu makalemizde işlediklerimizden yanımıza kar kalanlar aşağıda listelenmektedir.
