        ...
        case 3:
            {
                ...
                /* Normal öncelik değeri. Varsayılan değer budur.*/
                break;
            }
        case 4:
            {
                tp1 = ThreadPriority.AboveNormal;
                /* Normalin biraz üstü öncelik değeri. */
                break;
            }
        case 5:
            {
                tp1 = ThreadPriority.Highest;
                /* En üst düzey öncelik değeri. */
                break;
            }
    }
...
private void btnBaslat1_Click(object sender, System.EventArgs e)
{
    ...
    OncelikBelirle();
    /* Öncelik ( Priority ) değerleri, iş parçacıkları Start metodu ile başlatılmadan önce belirlenmelidir. */
