...
func main() {
    ...
    fmt.Println("Age(from pointer)", * pAge) * pAge = 41
    fmt.Println("Age=", age)
    fmt.Println("Age(from pointer)", * pAge)

    point: = 1000
    pPoint: = & point * pPoint = * pPoint * 2
...
func callWithPointer(value * int) { * value += 1
...
func main() {
    ...
    fmt.Println("Current value", * nickP) * nickP = "speedy gonzales"
