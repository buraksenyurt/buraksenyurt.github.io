...
- #2 ve #3 de LevelController ve Player isimli iki sınıf tanımlaması yapıldığı görülebilir. LevelControllersınıfında $levelLimit isimli global değişkene erişen iki fonksiyon yer almaktadır. Bu fonksiyonlarıLevelController nesne örnekleri üzerinden kullanabiliriz ki  `#12`de bu işlem icra edilir.
