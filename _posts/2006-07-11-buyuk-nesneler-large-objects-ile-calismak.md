...
> Özellikle boyutu 8000 byte'ın üzerinde olan büyük nesneleri okurken veya yazarken parçalı olarak ele almak uygulama performansını arttırıcı bir etkendir. Nitekim uygulamanın çalıştığı sistem her zaman çok yüksek boyuta sahip nesneleri taşıyabilecek kapasitede donanıma sahip olamayabilir.
